...
class WaitingManager extends EventEmitter {
  ...
  enqueue(parsedObj) {
    return new Promise((resolve, reject) => {
      ...
      this.redis.check_waiting('active:' + parsedObj.query.url +
          ':' + parsedObj.query.id, 'activeQ:' + parsedObj.query.url,
          'waitingQ:' + parsedObj.query.url, 'waiting:' + parsedObj.query.url +
          ':' + parsedObj.query.id,
          maxActiveCount[parsedObj.query.url],
